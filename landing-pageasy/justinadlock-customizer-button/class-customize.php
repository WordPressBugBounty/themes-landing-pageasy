...
final class landing_pageasy_theme_Customize {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_style( 'landing-pageasy-customize-controls', trailingslashit( get_template_directory_uri() ) . 'justinadlock-customizer-button/customize-controls.css', array(), "3.0");
	}
}
