		...
		<div class="row" id="copyright-note">
			<span>
				...
				<span class="footer-info-right">
					<?php echo __(' | Theme Design by', 'landing-pageasy') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'landing-pageasy'); ?>" rel="nofollow noopener"><?php echo __('SuperbThemes.com', 'landing-pageasy') ?></a>
				</span>
